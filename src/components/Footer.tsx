...
export default function Footer() {
  return (
    <footer className="border-t border-border-light pt-[35px] pb-[90px] px-[35px] max-w-[1500px] mx-auto grid gap-[70px]">
      <div id="footer-links" className="grid grid-cols-1 lg:grid-cols-[1fr_291px] gap-[35px]">
        <div id="footer-main-links" className="flex flex-wrap gap-[45px] text-sm uppercase font-silka font-semibold">
          <Link href="/contact">Contact</Link>
          <Link href="/privacy">Privacy Policy</Link>
          <Link href="/cookies">Cookies Policy</Link>
          <Link href="/legal">Legal Notice</Link>
        </div>
        <div id="footer-social-links" className="flex gap-[35px] justify-start lg:justify-end">
          {/* Social Icons */}
          <a href="#" className="w-[25px] h-[25px] bg-primary-black rounded-full block"></a>
          <a href="#" className="w-[25px] h-[25px] bg-primary-black rounded-full block"></a>
          <a href="#" className="w-[25px] h-[25px] bg-primary-black rounded-full block"></a>
        </div>
      </div>
