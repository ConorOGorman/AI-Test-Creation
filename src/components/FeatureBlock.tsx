...
export default function FeatureBlock({ title, subtitle, image, linkText, linkUrl, reversed = false }: FeatureBlockProps) {
  return (
    <section className="py-11.25 px-8.75 max-w-375 mx-auto">
      <div className={`flex flex-col ${reversed ? 'md:flex-row-reverse' : 'md:flex-row'} gap-8.75 items-center`}>
        ...
        <div className={`w-full md:w-3/5 flex flex-col justify-center ${reversed ? 'items-end text-right' : 'items-start text-left'} p-8`}>
